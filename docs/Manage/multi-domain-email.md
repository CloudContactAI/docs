...
3. If you're using AWS SES, then you'll be want to configure this domain for [SES deliverability](https://developer.cloudcontactai.com/docs/configure-aws-ses).
