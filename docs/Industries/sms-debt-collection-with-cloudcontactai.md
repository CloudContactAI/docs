...
In CloudContactAI, the default CSV template to upload a list of contacts is not for Debt Collection. Please use this template, [test_collections_1-30dpd.csv](https://dev.cloudcontactai.com/wp-content/uploads/2022/12/test_collections_1-30dpd.csv).
...
[block:parameters]
{
  "data": {
    ...
    "3-1": "Amazon",
    "4-1": "123",
    "5-1": "https://www.stripe.com",
    "6-1": "4158906431",
    "7-1": "info@cloudcontactai.com",
    "8-1": "12/19/22",
    "9-1": "The Collectors"
  },
  "cols": 2,
...
In the Add Contacts view, I’m going to upload the default collection template file. I’m going to entitle the list the name of the file “test_collections_1-30dpd.csv”.
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3ce61c6-cloudcontactai-debt-collection-template-add-contacts.png",
        "cloudcontactai-debt-collection-template-add-contacts.png",
        1059,
        1004,
        "#000000"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f6f2f87-cloudcontactai-debt-collection-template-add-contact-list.png",
        "cloudcontactai-debt-collection-template-add-contact-list.png",
        2204,
        337,
        "#000000"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fb114bb-cloudcontactai-debt-collection-template-contact-details.png",
        "cloudcontactai-debt-collection-template-contact-details.png",
        1523,
        902,
        "#000000"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2607a4a-cloudcontactai-debt-collection-template-sms-campaign.png",
        "cloudcontactai-debt-collection-template-sms-campaign.png",
        1097,
        600,
        "#000000"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/da1d9ed-cloudcontactai-debt-collection-template-sms-campaign-2.png",
        "cloudcontactai-debt-collection-template-sms-campaign-2.png",
        1080,
        720,
        "#000000"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2ae00d1-cloudcontactai-debt-collection-template-sms-campaign-3.png",
        "cloudcontactai-debt-collection-template-sms-campaign-3.png",
        1837,
        693,
        "#000000"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/51499e3-cloudcontactai-debt-collection-template-sms-campaign-4.png",
        "cloudcontactai-debt-collection-template-sms-campaign-4.png",
        971,
        173,
        "#000000"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a59ab13-cloudcontactai-debt-collection-template-sms-campaign-5.png",
        "cloudcontactai-debt-collection-template-sms-campaign-5.png",
        2209,
        688,
        "#000000"
      ]
