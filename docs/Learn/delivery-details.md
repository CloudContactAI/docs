...
![677](https://files.readme.io/e638a87-Screenshot_2022-10-14_094256.png "Screenshot 2022-10-14 094256.png")
...
## Pointers for Message Deliverability

* Make sure any two variants of campaign are sufficiently different from each other.
* Try to personalize messages to the customer. Include properties like the customer’s first name by including: \{first\_name}
